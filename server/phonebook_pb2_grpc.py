...
class PhonebookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetNumberByName = channel.unary_unary(
                '/phonebook.PhonebookService/GetNumberByName',
                request_serializer=phonebook__pb2.NameRequest.SerializeToString,
...
def add_PhonebookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetNumberByName': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNumberByName,
                    request_deserializer=phonebook__pb2.NameRequest.FromString,
...
class PhonebookService(object):
    ...
    def GetNumberByName(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/phonebook.PhonebookService/GetNumberByName',
            phonebook__pb2.NameRequest.SerializeToString,
